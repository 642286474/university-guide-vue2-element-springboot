...
export default {
  ...
  data() {
    return {
      ...
      //测试数据
      infor: [
        { id: '1', left: 'left:' + '66%', top: 'top:' + '55%', name: '第一教学楼' },
        { id: '2', left: 'left:' + '68%', top: 'top:' + '57%', name: '第二教学楼' },
        { id: '3', left: 'left:' + '64%', top: 'top:' + '52%', name: '第三教学楼' },
        { id: '4', left: 'left:' + '71%', top: 'top:' + '52%', name: '国际楼' },
        { id: '5', left: 'left:' + '46%', top: 'top:' + '62%', name: '艺术楼' },
        { id: '6', left: 'left:' + '40%', top: 'top:' + '60%', name: '第四教学楼' },
        { id: '7', left: 'left:' + '39%', top: 'top:' + '57%', name: '第五教学楼' },
        { id: '8', left: 'left:' + '38%', top: 'top:' + '54%', name: '第六教学楼' },
        { id: '9', left: 'left:' + '39%', top: 'top:' + '46%', name: '第七教学楼' },
        { id: '0', left: 'left:' + '42%', top: 'top:' + '52%', name: '实训楼' },
        { id: '11', left: 'left:' + '22%', top: 'top:' + '57%', name: '康大实训楼' },
        { id: '12', left: 'left:' + '24%', top: 'top:' + '60%', name: '康大教学楼' },
        { id: '13', left: 'left:' + '50%', top: 'top:' + '44%', name: '教师食堂' },
        { id: '14', left: 'left:' + '71%', top: 'top:' + '57%', name: '同乐园' },
        { id: '15', left: 'left:' + '51%', top: 'top:' + '62%', name: '同德园' },
        { id: '16', left: 'left:' + '56%', top: 'top:' + '49%', name: '小东湖饭堂' },
        { id: '17', left: 'left:' + '49%', top: 'top:' + '54%', name: '幸福食堂' },
        { id: '18', left: 'left:' + '35%', top: 'top:' + '51%', name: '感恩食堂' },
        { id: '19', left: 'left:' + '20%', top: 'top:' + '47%', name: '同心圆' },
        ...
        { id: '51', left: 'left:' + '16%', top: 'top:' + '50%', name: '康大宿舍' },
        { id: '52', left: 'left:' + '15%', top: 'top:' + '54%', name: '康大宿舍' },
        { id: '53', left: 'left:' + '67%', top: 'top:' + '67%', name: '图书馆' },
        { id: '54', left: 'left:' + '44%', top: 'top:' + '58%', name: '创客空间' },
        { id: '55', left: 'left:' + '70%', top: 'top:' + '63%', name: '羽毛球场' },
        { id: '56', left: 'left:' + '67%', top: 'top:' + '46%', name: '广商足球场' },
        { id: '57', left: 'left:' + '33%', top: 'top:' + '55%', name: '体育馆' },
        { id: '58', left: 'left:' + '37%', top: 'top:' + '62%', name: '篮球场' },
        { id: '59', left: 'left:' + '33%', top: 'top:' + '62%', name: '网球场' },
        { id: '60', left: 'left:' + '48%', top: 'top:' + '66%', name: '第一行政楼' },
        { id: '61', left: 'left:' + '58%', top: 'top:' + '49%', name: '第二行政楼' },
        { id: '62', left: 'left:' + '51%', top: 'top:' + '56%', name: '第三行政楼' },
        { id: '63', left: 'left:' + '54%', top: 'top:' + '50%', name: '专家楼' },
        { id: '64', left: 'left:' + '53%', top: 'top:' + '44%', name: '小东湖' },
        { id: '65', left: 'left:' + '42%', top: 'top:' + '54%', name: '学生服务中心' },
        { id: '66', left: 'left:' + '35%', top: 'top:' + '66%', name: '驿站' },
        { id: '67', left: 'left:' + '18%', top: 'top:' + '50%', name: '驿站' },
        { id: '68', left: 'left:' + '27%', top: 'top:' + '63%', name: '康大校门' },
        { id: '69', left: 'left:' + '27%', top: 'top:' + '56%', name: '教师新村校门' },
        { id: '70', left: 'left:' + '39%', top: 'top:' + '67%', name: '北门' },
        { id: '71', left: 'left:' + '47%', top: 'top:' + '68%', name: '中门' },
        { id: '72', left: 'left:' + '61%', top: 'top:' + '73%', name: '广州商学院校门' },
      ],
    }
  },
